const BuiltWith = () => {
  return (
    <div className="absolute right-1/2 translate-x-1/2 bottom-24 xl:bottom-10 md:bottom-16 xl:right-[10%] xl:translate-x-1/2 z-20 w-[300px] sm:w-[400px] xl:w-[300px] h-20 opacity-60">
      <div>
